  ...
  <div>
     <div id="container">
          ...
          <div class="fan">{{pickerText}}</div>
				...
				<div class="Wecname1">
					<p>微信群总人数</p>
					<input type="number" id="WechatTotal" placeholder="请输入总人数" @blur="WechatTotal"/>人
				</div>
				<div class="pic">
					<div class="Left">
						<p>微信头像</p>
    ...
    showSinglePicker() {
      ...
      this.$refs.mpvuePicker.show();
        ...
        this.pickerText2 = e.label
			...
			WechatTotal(e){
				 var that = this;
				 var WechatTotal = e.mp.detail.value
				 that.Wt = WechatTotal
			},
			bindContentFocus(e) {
			...
			release(e){
				...
				var qrcode = that.Twodimensional
					...
					if(Cty == "" || VS == "" || WN == ""  || titlepic == "" || ewm == "" || WT == "" || qrcode == ""){
							wx.showToast({
								title: '请核对',
								icon: 'loading',
								duration: 1000
