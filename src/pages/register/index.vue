      ...
      <div class="section">
        <div class="section-1">
          ...
          <div class="phoneNumber action">
            <input type="number" placeholder="输入本人手机号" id="username" @blur='getusername' auto-focus>
          </div>
    ...
    methods: {
      ...
      getsmCode(){
          ...
          if (this.username == "") {
            ...
            wx.request({
              ...
              'url': 'https://qq.zhongyi9999.com/e/extend/api/index.php?m=user&c=register',
              success:(res) => {
      ...
      register(){
        ...
        var unionId = wx.getStorageSync('unionId');
         ...
         if(_this.username == "" || _this.password == "" || _this.repassword == ""  || _this.rzm == ""){
            wx.showToast({
              title: '请核对',
              icon: 'loading',
              duration: 1000
              ...
              var that = this;
              let data = {'username':_this.username,'password':_this.password,'repassword':_this.repassword,'rzm':_this.rzm,"unionid":unionId}
               wx.request({
                  url: 'https://qq.zhongyi9999.com/e/extend/api/index.php?m=user&c=register',
                  header: {
...
.section-1 .phoneNumber,.section-1 .smcode,.section-1 .possword,.section-1 .R-possword{
	width:100%;
	height:50px;
	margin-top: 15px;
...
.section-1 .phoneNumber input,.section-1 .possword input,.section-1 .R-possword input{
	width:80%;
	height:50px;
	margin-left: 45px;
	/* margin-top: 6px; */
