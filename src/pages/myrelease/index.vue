                ...
                <div class="Wrap">
                  <div class="s-l" v-for="list in lists" :key="key">
                    ...
                    >
                      <div class="s-l-d">
                        <div class="s-l-d-p">
                          <img :src="list.new_titlepic" :alt="list.title">
                        </div>
                        <div class="s-l-d-i">
...
export default {
  ...
  mounted(data) {
    ...
    var that = this;
    wx.request({
      url:"https://qq.zhongyi9999.com/e/extend/api/index.php?m=user&c=userinfo",
      data: {
        userid: userId,
        type: "fbjl",
        checked: "1",
      ...
      success(data) {
        ...
        for (var i = 0; i < hanyeList.length; i++) {
          var obj = new Object();
          obj.smalltext = hanyeList[i].smalltext;
          obj.title = hanyeList[i].title;
          obj.new_titlepic = hanyeList[i].new_titlepic;
          obj.weixin = hanyeList[i].weixin;
          obj.smsg = hanyeList[i].smsg;
          obj.id = hanyeList[i].id;
          obj.classid = hanyeList[i].classid;
          obj.city = hanyeList[i].city;
          that.lists.push(obj);
    ...
    wx.request({
      ...
      success(data) {
        ...
        for (var i = 0; i < hanyeList.length; i++) {
          ...
          obj.classid = hanyeList[i].classid;
          obj.city = hanyeList[i].city;
          obj.nocheckcause = hanyeList[i].nocheckcause;
          that.lists2.push(obj);
        }
      }
          })
