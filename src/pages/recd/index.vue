      ...
      <div class="container">
        <div class="Wrap">
          <div class="s-l" v-for="(id,index) in lists" :key="index">
            <div class="s-l-d">
              <div class="s-l-d-p">
                <div class="Wei">[{{id.classname}}]<span class="gl">{{id.title}}</span></div>
                <div>{{id.truetime}}</div>
              </div>
              <div class="s-l-d-i">
                <div class="s-l-i-t">
                  <div class="Wei1">-{{id.cardfen}}.00</div>
                  <!-- <div>余额: 95.00</div> -->
                </div>
              </div>
            </div>
       ...
       wx.request({
        ...
        success(data) {
          ...
          for (var i = 0; i < itemArray.length; i++) {
            var obj = new Object();
            obj.classname = itemArray[i].classname;
            obj.title = itemArray[i].title;
            obj.truetime = itemArray[i].truetime;
